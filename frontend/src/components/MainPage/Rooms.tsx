...
function Rooms() {
  ...
  return (
    <Box sx={{ height: '100%', padding: '1em', boxSizing: 'border-box', backgroundColor: theme.palette.background.paper, width: "100%",
      display:"flex", flexDirection:"column", gap:2, minWidth: "200px", maxWidth:"200px"
     }}>
      ...
      <Box sx={{ border: '1px solid', borderColor: theme.palette.divider, borderRadius: 1, boxShadow: 1, marginTop: "auto", }}>
        <Button component={Link} to="/main/dashboard" style={roomStyle("/main/dashboard")}>Dashboard</Button>
      </Box>
    </Box>
  )
}
